...
const PracticePersonal = () => {
  return (
    <div className="practicePersonalContainer">

      <div className="practicePersonalInner">
        <p style={{ color: "#828282" }}>Practice Areas</p>
        <h1 style={{ color: "#310C4B" }}>Personal</h1>
        <hr className="HR" />
        ...
        <div className="gridedGap">
          ...
          <div className="helpCard">
            ...
            <div>
              <h5 className="helpHeader">Intellectual Property </h5>
              <hr className="helpHR" />
              <p className="paragragh">
                There are many variations of passages of Lorem There are many
                variations of passages of Lorem
          ...
          <div className="helpCard">
            ...
            <div>
              <h5 className="helpHeader">Employment Law</h5>
              <hr className="helpHR" />
              <p className="paragragh">
                There are many variations of passages of Lorem There are many
                variations of passages of Lorem
          ...
          <div className="helpCard2">
            ...
            <div>
              <h5 className="helpHeader">Estate & Trust</h5>
              <hr className="helpHR" />
              <p className="paragragh">
                There are many variations of passages of Lorem There are many
                variations of passages of Lorem
          ...
          <div className="helpCard2">
            ...
            <div>
              <h5 className="helpHeader">Contracts & Transactions</h5>
              <hr className="helpHR" />
              <p className="paragragh">
                There are many variations of passages of Lorem There are many
                variations of passages of Lorem
          ...
          <div className="helpCard3">
            <img src={user} alt="" className="helpImg" />
            <div>
              <h5 className="helpHeader">Consumer Rights</h5>
              <hr className="helpHR" />
              <p className="paragragh">
                There are many variations of passages of Lorem There are many
                variations of passages of Lorem
          ...
          <div className="helpCard3">
            ...
            <div>
              <h5 className="helpHeader">
                Dispute Resolution- Civil & Commercial
              </h5>
              <hr className="helpHR" />
              <p className="paragragh">
                There are many variations of passages of Lorem There are many
          ...
          <div className="helpCard3">
            ...
            <div>
              <h5 className="helpHeader">Case Assessment/Review</h5>
              <hr className="helpHR" />
              <p className="paragragh">
                There are many variations of passages of Lorem There are many
                variations of passages of Lorem
      ...
      <div className="practicePersonalInner">
      <p style={{ color: "#828282" }}>Practice Areas</p>
        <h1 style={{ color: "#310C4B" }}>Corporate</h1>
        <hr className="HR" />
        ...
        <div className="gridedGap">
          ...
          <div className="helpCard">
            <img src={anchor} alt="" className="helpImg" />
            <div>
              <h5 className="helpHeader">Corporate Governance & Board Advisory/Services (Evaluation & Trainings)</h5>
              <hr className="helpHR" />
              <p className="paragragh">
                There are many variations of passages of Lorem There are many
                variations of passages of Lorem
          ...
          <div className="helpCard">
            <img src={layers} alt="" className="helpImg" />
            <div>
              <h5 className="helpHeader">In-house Legal department framework/capability development/staffing </h5>
              <hr className="helpHR" />
              <p className="paragragh">
                There are many variations of passages of Lorem There are many
                variations of passages of Lorem
          ...
          <div className="helpCard2">
            <img src={slack} alt="" className="helpImg" />
            <div>
              <h5 className="helpHeader">Start Up & Technology Law</h5>
              <hr className="helpHR" />
              <p className="paragragh">
                There are many variations of passages of Lorem There are many
                variations of passages of Lorem
          ...
          <div className="helpCard3">
            <img src={user} alt="" className="helpImg" />
            <div>
              <h5 className="helpHeader">Compliance framework & services</h5>
              <hr className="helpHR" />
              <p className="paragragh">
                There are many variations of passages of Lorem There are many
                variations of passages of Lorem
          ...
          <div className="helpCard4">
            <img src={box} alt="" className="helpImg" />
            <div>
              <h5 className="helpHeader">Legal Risk Management</h5>
              <hr className="helpHR" />
              <p className="paragragh">
                There are many variations of passages of Lorem There are many
                variations of passages of Lorem
          ...
          <div className="helpCard2">
            <img src={slack} alt="" className="helpImg" />
            <div>
              <h5 className="helpHeader">Antitrust/Competition Law</h5>
              <hr className="helpHR" />
              <p className="paragragh">
                There are many variations of passages of Lorem There are many
                variations of passages of Lorem
          ...
          <div className="helpCard2">
            <img src={dollar} alt="" className="helpImg" />
            <div>
              <h5 className="helpHeader">Regulatory & enforcement</h5>
              <hr className="helpHR" />
              <p className="paragragh">
                There are many variations of passages of Lorem There are many
                variations of passages of Lorem
...
export default PracticePersonal;
